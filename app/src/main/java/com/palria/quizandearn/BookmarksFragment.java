...
import com.palria.quizandearn.adapters.BookmarksRcvAdapter;
...
//                           final boolean isTutorialBookmark = (documentSnapshot.get(GlobalConfig.IS_TUTORIAL_BOOK_MARK_KEY))!=null ? (documentSnapshot.getBoolean(GlobalConfig.IS_TUTORIAL_BOOK_MARK_KEY))  :false;
                           ...
                           final String quizId = ""+ documentSnapshot.get(GlobalConfig.QUIZ_ID_KEY);
                                        ...
                                        public void onFailure(@NonNull Exception e) {
                                            ...
                                            .addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                                                ...
                                                public void onSuccess(DocumentSnapshot documentSnapshot) {
                                                    ...
                                                    bookmarkFetchListener.onSuccess(new BookmarkDataModel(type,   authorId,   quizId,  userName,  description,  profilePhotoDownloadUrl,  dateBookmarked));
                                                }
                                            });
                                    break;

                                default:
                                    bookmarkFetchListener.onSuccess(new BookmarkDataModel("type",   authorId,  quizId,  "Title unknown",  "",  "",  dateBookmarked));
